...
import { FiUser, FiMail, FiLock, FiCheckCircle, FiAlertCircle, FiUserPlus } from 'react-icons/fi';
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-bg-light dark:bg-[#1a1a2e] flex items-center justify-center py-8 sm:py-12 px-4">
      <div className="max-w-md w-full bg-white dark:bg-[#2a2a2a] rounded-2xl shadow-xl p-6 sm:p-8 mx-4 sm:mx-0">
        
        <div className="text-center mb-6 sm:mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#2D3A2B] dark:text-white">Create Account</h2>
          <p className="text-sm sm:text-base text-[#2D3A2B]/60 dark:text-gray-400 mt-1 sm:mt-2">Join NexCart today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
          ...
          {/* Name Field */}
          <div>
            <label className="block text-[#2D3A2B] dark:text-gray-300 mb-1 sm:mb-2 text-sm sm:text-base">Full Name</label>
        ...
        <p className="text-center text-[#2D3A2B]/60 dark:text-gray-400 mt-5 sm:mt-6 text-sm sm:text-base">
          ...
          <Link to="/login" className="text-[#AE2448] hover:underline transition-colors">
            Sign In
          </Link>
        </p>
      </div>
